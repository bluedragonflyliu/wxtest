    ...
    //从接收到的消息中获取用户输入的文本内容， 作为一个查询的关键字， 使用trim()函数去两边的空格
        $keyword = trim($object->Content);
            ...
            $content[] = array(
                ...
                "Description"=>"单图文内容",
                "PicUrl"=>"http://wx-test.xiniubox.com/liufu/images/aa.jpg",
                "Url" =>"http://wx-test.xiniubox.com/liufu/sdkTest.php"
                );
                ...
                $content[] = array(
                    ...
                    "PicUrl"      =>"http://wx-test.xiniubox.com/liufu/images/Desert.jpg", 
                    "Url"         =>"http://wx-test.xiniubox.com/liufu/sdkTest.php"
                    );
                $content[] = array(
                    "Title"       => "多图文2标题",
                    "Description" => "不要到处去问别人该用什么",
                    "PicUrl"      => "http://wx-test.xiniubox.com/liufu/images/Chrysanthemum.jpg", 
                    "Url"         => "http://wx-test.xiniubox.com/liufu/sdkTest.php"
                    );
                $content[] = array(
                    "Title"       => "多图文3标题",
                    "Description" => "黄花菜可能都凉了。",
                    "PicUrl"      => "http://wx-test.xiniubox.com/liufu/images/Koala.jpg",
                    "Url"         => "http://wx-test.xiniubox.com/liufu/sdkTest.php"
                    );
                ...
                $content = array(
                    ...
                    "MusicUrl"    => "http://wx-test.xiniubox.com/liufu/audios/连丽如_大隋唐_001.mp3",
                    "HQMusicUrl"  => "http://wx-test.xiniubox.com/liufu/audios/连丽如_大隋唐_001.mp3"
                    );
                ...
                $content[] = array(
                    ...
                    "PicUrl"      => "http://wx-test.xiniubox.com/liufu/images/Tulips.jpg", 
                    "Url"         => "http://wx-test.xiniubox.com/liufu/sdkTest.php"
                    );
            } else {
